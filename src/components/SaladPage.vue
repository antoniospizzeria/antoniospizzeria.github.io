...
export default {
  ...
  return {
    ...
    foodColumnWidth: '',
    items: [
    { name: 'Small garden Salad', price: '$7.00', vegan: 'yes'},
    { name: 'Large Garden Salad', price: '$9.00', vegan: 'yes'},
    { name: 'Antipasto Salad', price: '$15.00', vegan: 'yes'},
    { name: 'Buffalo Chicken Salad', price: '$15.00'},
    { name: 'Buffalo Grilled Chicken Salad', price: '$15.00'},
    { name: 'Buffalo Seitan Chicken Salad', price: '$15.00', vegan: 'yes'},
    { name: 'Fried Chicken Salad', price: '$15.00'},
    { name: 'Greek Salad', desc: 'Greek dressing and Feta instead of Mozzarella', price: '$10.00', vegan: 'yes'},
    { name: 'Grilled Chicken Salad', price: '$15.00'},
    { name: 'Seitan Chicken Salad', price: '$15.00', vegan: 'yes'},
    { name: 'Steak Salad', price: '$15.00'},
